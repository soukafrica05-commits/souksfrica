...
export default function Footer() {
  ...
  const reseauxSociaux = [
    {
      nom: 'Facebook',
      href: 'https://web.facebook.com/soukafrica1/',  
      icon: (
    ...
    {
      nom: 'Instagram',
      href: 'https://www.instagram.com/soukafrica05/',  
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      nom: 'LinkedIn',
      href: 'https://www.linkedin.com/in/souk-africa-4a30b140a/',  
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      nom: 'YouTube',
      href: 'https://www.youtube.com/@SoukAfrica',  
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      nom: 'TikTok',
      href: 'https://www.tiktok.com/@soukafrica05',  
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
